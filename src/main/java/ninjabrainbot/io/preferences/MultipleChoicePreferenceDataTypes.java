...
public class MultipleChoicePreferenceDataTypes {
	...
	public enum Language implements IMultipleChoicePreferenceDataType {
		...
		ZH_TW(I18n.getLanguageName(Locale.TRADITIONAL_CHINESE)), JA_RYU(I18n.getLanguageName(I18n.ja_RYU)), RU_RU(I18n.getLanguageName(I18n.ru_RU)), PT_BR(I18n.getLanguageName(I18n.pt_BR)), ES_ES(I18n.getLanguageName(I18n.es_ES));
